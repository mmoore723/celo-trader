  ...
  return (
    <div className="p-4 max-w-2xl flex flex-col gap-4">
      ...
      <div className="card p-4">
        ...
        <Toggle label="ORB (Opening Range Breakout)" checked={form.orb_enabled}
                onChange={(v) => set("orb_enabled", v)} />
        <Toggle label="VWAP Pullback" checked={form.vwap_pullback_enabled}
                onChange={(v) => set("vwap_pullback_enabled", v)} />
        <Toggle label="Fair Value Gap (FVG)" checked={form.fvg_enabled}
                onChange={(v) => set("fvg_enabled", v)} />
        <Toggle label="BOS / MSS" checked={form.bos_mss_enabled}
